...
public class Activity extends ContextThemeWrapper
    ...
    private void detectCornersGesture(MotionEvent e) {
        ...
        final int exitItem = Build.MODEL.equals("RVMON7 CTRL PCB") ? Integer.parseInt(SystemProperties.get("persist.kioskmode.exitmode", "1")) : Integer.parseInt(SystemProperties.get("persist.kioskmode.exitmode", "0"));
